          ...
          <table width='100%'  border='0' cellspacing='0' cellpadding='0'>
            <tr>
              ...
              <td width='354'><div align='right' class='style7'>
                <div align="center"><font face=verdana size=2><a href="indexcliente_loginmais.php?valor=34343242&c=<? echo $codificada; ?>&NOM_FANTAS=<? echo $NOM_FANTAS; ?>">Clique aqui para visualizar e baixar todos os Xml e cadastrar seu e-mail para envio XML automaticamente.</a></font></div>
              </div></td>
                  ...
                  <td width='75%' colspan='2' valign='top' bgcolor='#F4F4F4'><div align='left'>
                    <table width='100%'  border='0' cellspacing='2' cellpadding='2'>
                        <tr>
                          ...
                          <td width="100%" valign="top"><? require_once("top10_1.php"); ?></td>
                        </tr>
                      </table>
                    </div>                    </td>
                  </tr>
