        ...
        <td height='0' valign='top' bgcolor='#F4F4F4'><div align='center'>
          <table width='100%'  border='0' cellspacing='0' cellpadding='0'>
            <tr>
              ...
              <td width='52'><div align="right"><span class="style7"><a href='logout.php' class='style5'>Sair</a>&nbsp;&nbsp;</span></div></td>
            </tr>
            <tr>
...
<form name="form1" method="post" action=<? echo "login_acessomais.php?c=$codificada"; ?>>
          <table width='100%'  border='0' cellspacing='0' cellpadding='0'>
            <tr>
                ...
                <tr>
                  <td width='75%' colspan='2' valign='top' bgcolor='#F4F4F4'><div align='left'>
                    <table width='100%'  border='0' cellspacing='2' cellpadding='2'>
                        <tr><BR><font face =verdana size=2>Para visualização de mais Notas e cadastrar seu e-email para recebimento dos arquivos automaticamente, por questões de segurança, digite uma senha cadastrada para ter acesso.<BR><br>
						Caso ainda não tenha uma senha, <a href="#" class="style1" onClick="MM_openBrWindow('<? echo "cadastro_email_mais.php?cgc=$codificada&testar=$test"; ?>','','width=450,height=300')">clique aqui para cadastrar sua senha!</a><BR><BR><BR>
                    <center>     CNPJ: <? echo $cgc; ?><br><br>
						 Senha: </font><br>
						 <input name="senhamais" type="password" id="senhamais"><br><br>
						 <input type="submit" name="Submit" value="Entrar">  <font face =verdana size=1><a href="#" class="style1" onClick="MM_openBrWindow('<? echo "reenviar.php?c=$codificada"; ?>','','width=450,height=300')">Reenviar senha</a><font><br><br><br><br>
