...
<form action='result.php?$consulta=$cliente&cgc=$cgc' method='post' name='result'>";
?>
<script language="JavaScript" type="text/JavaScript">
<!--
          ...
          <table width='100%'  border='0' cellspacing='0' cellpadding='0'>
            <tr>
              ...
              <td width='354'><div align='right' class='style7'>
                <div align="center"><a href="#" class="style1" onClick="MM_openBrWindow('<? echo "cadastro_email.php?cgc=$codificada&testar=$test"; ?>','','width=450,height=300')">Cadastre Aqui para Receber Xml em seu E-mail </a></div>
              </div></td>
                  ...
                  <td width='75%' colspan='2' valign='top' bgcolor='#F4F4F4'><div align='left'>
                    <table width='100%'  border='0' cellspacing='2' cellpadding='2'>
                        <tr>
                          ...
                          <td width="73%" valign="top"><? require_once("top10.php"); ?></td>
                        </tr>
                      </table>
                    </div>                    </td>
                  </tr>
